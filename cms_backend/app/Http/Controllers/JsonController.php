...
/* ************************************************************************************************************* */
            ...
            $mainJSON['url'] = array(
                'imageUrl' => "http://35.163.93.93/json/".$appData->app_code."/".$appData->version."/"
            );
...
//                  For Google/Picasa Album
                    ...
                    elseif($element['menu_type'] == 11)
                    {
                        $getAlbumMenuJsonData = Helpers::getAlbumMenuJsonData($menuTypeJsonDataDecode->css_string_json);
                        $element['css'] = $getAlbumMenuJsonData;
                        if(isset($menuTypeJsonDataDecode->contact_form_json))
                        {
                            $element['value']['contact_form_json'] = $menuTypeJsonDataDecode->contact_form_json;
                        }
