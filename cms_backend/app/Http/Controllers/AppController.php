...
class AppController extends Controller {
    ...
    public function addscreenshot(Request $request)
    {
        ...
        if($user) 
        {
            ...
            //         $fileName = 'appscreenshot_' . time() . '.png';
            ...
            $insertjsonData['order'] = $body['sort_id'];
    ...
    //         $app_id = $body['app_id'];
    //         // check app publish counter
    // //         $checkAppPublishCounter = DB::table('app_basic')->wherif(!empty($jsonSectionData))
    //         {
    //             foreach($jsonSectionData as $k=>$v)
    //             {
    //                 $value = array();
