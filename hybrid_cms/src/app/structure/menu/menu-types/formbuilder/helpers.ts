...
import { MenuTypeContactComponent } from './../menu-type-contact-component';
import { MenuConfigurationComponent } from 'app/structure/menu/menu-configuration.component';
...
export default class Helpers {
    ...
    save(stage = null) {
        ...
        MenuTypeContactComponent.prototype.viewSavedInfo(data.formData);
